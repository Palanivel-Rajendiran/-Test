...
export class InterceptorService implements HttpInterceptor {
    intercept(req: HttpRequest<any>, next: HttpHandler): Observable<HttpEvent<any>> {
        ...
        const token = 'eyJhbGciOiJIUzUxMiJ9.eyJzdWIiOiJBVVRPMDEiLCJlbWFpbF9JZCI6IkJBSkFKU3lzdGVtQHRlc3F1aXJlbC5jb20iLCJlbXBfQ29kZSI6IlN5c3RlbSIsIm9yZ19Db2RlIjoiQkFMSUMiLCJsYW5nX0NvZGUiOiJFIiwiZG9tYWluX0NvZGUiOiJJTlMiLCJzdWJkb21haW5fQ29kZSI6IkxJRkUiLCJ1c2VyX0lkIjoiQVVUTzAxIiwiZXhwIjoxNTc4NTUyMDU5fQ.YG9PHR933JeneYzsIINw_T1te2UcYeKmccDw3T3MS2FPfGW35t1YP_5jYsgp0t73tPms78I2KUIdSAjFxUhFnA'; // auth is provided via constructor.
